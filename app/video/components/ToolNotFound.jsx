  ...
  return (
    <div className="max-w-2xl mx-auto mt-20 text-center">
      ...
      <p className="text-gray-400 text-lg mb-8">
        We couldn't find a tool named <span className="text-red-400 font-mono bg-red-500/10 px-2 py-0.5 rounded">"{invalidToolName}"</span>.
      </p>
      ...
      {recommendedTool && (
        <div className="bg-neutral-900/80 border border-white/10 rounded-2xl p-6 mb-8 max-w-md mx-auto">
          ...
          <Link 
            href={`/video/${slugify(recommendedTool)}`}
            className="group flex items-center justify-between p-4 bg-white/5 hover:bg-green-500/10 border border-white/10 hover:border-green-500/50 rounded-xl transition-all duration-300"
          >
